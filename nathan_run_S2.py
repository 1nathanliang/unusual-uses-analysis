...
raw_data = pd.read_csv('data/S2/mildner_pre_balloon_0_metamorph.csv') # <---- UPDATE THIS EACH TRIAL
...
creativity[['clean_response', 'elaboration', 'flexibility']] = \
    calc_flexibility_and_elaboration(list(data_by_response.response), u'balloon', nlp) # <---- UPDATE THIS EACH TRIAL
...
creativity.to_csv('data/S2/runs_S2/mildner_pre_balloon_0_run_S2.csv') # <---- UPDATE THIS EACH TRIAL
creativity_by_participant.to_csv('data/S2/runs_S2/mildner_by_participant_rpre_balloon_0_run_S2.csv') # <---- UPDATE THIS EACH TRIAL
